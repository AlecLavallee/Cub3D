...
/*   Updated: 2021/07/01 18:19:05 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

unsigned int	get_color_sprite(t_cub *cub)
{
	t_texture	*tex_ptr;
	int			*color_ptr;
	int			color;
...
void	draw_sprite_pixel(t_cub *cub, int x, int y, unsigned int color)
{
	...
	img_data = (unsigned int *)mlx_get_data_addr(cub->image.img_ptr, \
